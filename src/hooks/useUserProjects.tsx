...
export default function useUserProjects() {
  ...
  const updateList = useCallback(async (projectId: string, listId: string, updates: Partial<List>) => {
    const updated = await apiEditList(projectId, listId, updates);
    setLists((prev) => prev.map((l) => (l.id === listId ? updated : l)));
  }, []);

  const addTask = useCallback(async (projectId: string, listId: string, task: Task) => {
  ...
  const updateTask = useCallback(async (projectId: string, listId: string, taskId: string, updates: Partial<Task>) => {
  ...
  const addSubtask = useCallback(async (projectId: string, listId: string, taskId: string, subtask: Subtask) => {
  ...
  const updateSubtask = useCallback(async (projectId: string, listId: string, taskId: string, subtaskId: string, updates: Partial<Subtask>) => {
